...
class FlowNetC(nn.Module):
    def __init__(self, batchNorm=True, div_flow = 20):
        ...
        self.predict_depth6 = predict_depth(1024)
        self.predict_depth5 = predict_depth(1025)
        self.predict_depth4 = predict_depth(769)
        self.predict_depth3 = predict_depth(385)
        self.predict_depth2 = predict_depth(193)
        ...
        self.upsampled_depth6_to_5 = nn.ConvTranspose2d(1, 1, 4, 2, 1, bias=True)
        self.upsampled_depth5_to_4 = nn.ConvTranspose2d(1, 1, 4, 2, 1, bias=True)
        self.upsampled_depth4_to_3 = nn.ConvTranspose2d(1, 1, 4, 2, 1, bias=True)
        self.upsampled_depth3_to_2 = nn.ConvTranspose2d(1, 1, 4, 2, 1, bias=True)
        ...
        self.upsample6 = nn.Upsample(scale_factor=64, mode='bilinear')
